var AetherUpload = {
    ...
    upload: function () {
        ...
        if (!this.product) {
            this.outputDom.text(this.messages.error_invalid_product);
            return;
        }

        if (!this.identify) {
            this.outputDom.text(this.messages.error_invalid_identify);
            return;
        }
    ...
    uploadChunk: function () {
        ...
        form.append('identify', this.identify);
    ...
    text: {
        en: {
            ...
            error_invalid_identify: 'Error: invalid identify',
        },
        zh: {
            ...
            error_invalid_product: '错误: 没有选择产品',
            error_invalid_identify: '错误: 没有选择包',
        }
    }
